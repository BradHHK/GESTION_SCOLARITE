...
ALTER TABLE etudiants MODIFY id_etudiant INT NOT NULL AUTO_INCREMENT;
ALTER TABLE enseignants MODIFY id_enseignant INT NOT NULL AUTO_INCREMENT;
ALTER TABLE matieres MODIFY id_matiere INT NOT NULL AUTO_INCREMENT;
ALTER TABLE filieres MODIFY id_filiere INT NOT NULL AUTO_INCREMENT;
ALTER TABLE evaluations MODIFY id_evaluation INT NOT NULL AUTO_INCREMENT;
COMMIT;
