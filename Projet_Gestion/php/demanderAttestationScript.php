...
<?php
    ...
    try {
        if (isset($_SESSION["id_utilisateurs_etudiant"])) {

            $id = $_SESSION["id_utilisateurs_etudiant"];
            ...
            $pdf->AddPage();
            $statement = $con->prepare("SELECT id_etudiant, Matricule, nom, prenom, date_naissance, id_filiere FROM etudiants where id_etudiant = ?");
            ...
            while($row = $result->fetch_assoc()){
                ...
                while($row2 = $result2->fetch_assoc()){
                    $contenu = "<div style='
                        ...
                        '>
                        <p>Le Directeur de l’École Supérieure de Technologie de Salé atteste que l’étudiant :</p>
                        
                        <p style='font-weight: bold; font-size: 1.1em;'>Monsieur/Madame ".$row["nom"]." ".$row["prenom"]."</p>
                        
                        <p>Matricule : <strong>".$row["Matricule"]."</strong></p>
                        
                        <p>Né le <strong>".$row["date_naissance"]."</strong></p>
                        
                        <p>Est inscrit au Diplôme Universitaire de Technologie à l’École Supérieure de Technologie de Salé pour l’année universitaire <strong>".date('Y')."</strong>.</p>
                        
                        <p><strong>Filière : ".$row2["nom_filiere"]."</strong></p>
                        
                        <br>
                        
                        <p style='text-align: right;'>Fait à Salé, le <strong>".date('l d F Y')."</strong></p>
                        <p style='text-align: right; font-weight: bold;'>Le Directeur</p>
                    </div>";
                }
