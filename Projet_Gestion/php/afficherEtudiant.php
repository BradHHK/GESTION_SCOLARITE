        ...
        <div class="optionAfficher">
            <div class="container">
                <div class="text-header">
                    ...
                    <div class="recherche-Pan"><input type="text" required placeholder="Matricule" name="matriculeEtudiant" id="matriculeEtudiant"><button type="submit" class="fa-solid fa-search" id="recherche"></button></div>
