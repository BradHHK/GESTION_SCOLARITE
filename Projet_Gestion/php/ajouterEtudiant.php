...
<body>
    <div class="head">
        ...
        <header class="header">
            <h5>Panneau Administrateur -  Ajouter un etudiant</h5>
    ...
    <div class="container">
        ...
        <div class="optionAjouter">  
            <form action="AjouterEtudiantScript.php" method="post"  class= "form">
                    ...
                    <div class="form-contain">
                        <table>
                            ...
                            <tr>
                                ...
                                <td><input type="date" name="dateNaissance" id="dateNaissance" required></td>
                            </tr>
                            <tr>
                                <td>Filiere </td>
                                <td>
