...
<head>
    ...
    <title>Panneau Administrateur - Modifer les matieres</title>
</head>
<body>
    <div class="head">
        <div class="arrow"><span class="logo_img" id="logo"></span></div>
        <header class="header">
            <h5>Panneau Administrateur - Modifer les matieres</h5>
        ...
        <div class="optionAfficher">
            <div class="container">
                <div class="text-header">
                    ...
                    <div class="recherche-Pan"><input type="text" required placeholder="Nom" name="nommatiereModifier" id="nommatiereModifier"><button type="submit" class="fa-solid fa-search" id="recherche"></button></div>
                </div>
                        ...
                        <?php 
                                ...
                                try {     
                                    ...
                                    while($row = $result->fetch_assoc()){
                                        ...
                                        echo"<td class='action-button'> <a href='modifierMatiere.php?id=".$row['id_matiere']."' title='modifier la matiere ".$row['nom_matiere']." '><i class='fas fa-edit'></i></a></td>";
