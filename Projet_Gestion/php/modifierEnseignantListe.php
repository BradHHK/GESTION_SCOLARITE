...
<head>
    ...
    <title>Panneau Administrateur - Modifier les enseignants</title>
</head>
<body>
    <div class="head">
        <div class="arrow"><span class="logo_img" id="logo"></span></div>
        <header class="header">
            <h5>Panneau Administrateur - Modifier les enseignants</h5>
        ...
        <div class="optionAfficher">
            <div class="container">
                <div class="text-header">
                    ...
                    <div class="recherche-Pan"><input type="text" required placeholder="Matricule" name="matriculeEnseignantModifier" id="matriculeEnseignantModifier"><button type="submit" class="fa-solid fa-search" id="recherche"></button></div>
                </div>
