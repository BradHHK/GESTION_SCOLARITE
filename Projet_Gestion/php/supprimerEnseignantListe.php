...
<head>
    ...
    <title>Panneau Administrateur - Supprimer les enseignants</title>
</head>
<body>
    <div class="head">
        <div class="arrow"><span class="logo_img" id="logo"></span></div>
        <header class="header">
            <h5>Panneau Administrateur - Supprimer les enseignants</h5>
        ...
        <div class="optionAfficher">
            <div class="container">
                <div class="text-header">
                    ...
                    <div class="recherche-Pan"><input type="text" required placeholder="Matricule" name="matriculeEnseignantSupprimer" id="matriculeEnseignantSupprimer"><button type="submit" class="fa-solid fa-search" id="recherche"></button></div>
                </div>
                                ...
                                try {     
                                    ...
                                    while($row = $result->fetch_assoc()){
                                        ...
                                        echo"<td><span><i class='fas fa-user-tie'></span></td>
                                            ...
                                            echo"<td class='action-button'><a href='supprimerEnseignant.php?id=".$row['id_enseignant']."' title='supprimer l enseignant ".$row['nom']." ' onclick='return confirm(".'"Supprimer l enseignant '.$row['nom'].'?"'.")'><i class='fas fa-trash'></i></a></td>";
                                        echo"</tr>";
                                    }
