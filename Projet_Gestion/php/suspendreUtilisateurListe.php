...
<head>
    ...
    <title>Panneau Administrateur - Suspendre les utilisateurs</title>
</head>
<body>
    <div class="head">
        <div class="arrow"><span class="logo_img" id="logo"></span></div>
        <header class="header">
            <h5>Panneau Administrateur - Suspendre les utilisateurs</h5>
            ...
            <div class="container">
                <div class="text-header">
                    <h5>Liste des utilisateurs</h5>
                         ...
                         <div class="recherche-Pan"><input type="text" required placeholder="login" name="loginSuspendre" id="loginSuspendre"><button type="submit" class="fa-solid fa-search" id="recherche"></button></div>
                        ...
                        <?php 
                                ...
                                try {     
                                    ...
                                    while($row = $result->fetch_assoc()){
                                        ...
                                        echo"<td class='action-button'></a> <a href='suspendreUtilisateur.php?id_account=".$row['id_accounts']."' title='suspendre l utilisateur ".$row['login']." ' onclick='return confirm(".'"Suspendre l utilisateur '.$row['login'].'?"'.")'><i class='fas fa-x'></i></a></td>";
                                        echo"</tr>";
                                    }
