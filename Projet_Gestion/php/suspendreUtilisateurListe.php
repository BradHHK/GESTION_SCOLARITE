                        ...
                        <?php 
                                ...
                                try {     
                                    ...
                                    while($row = $result->fetch_assoc()){
                                        ...
                                        echo"<td class='action-button'></a> <a href='suspendreUtilisateur.php?id_account=".$row['id_accounts']."' title='suspendre l utilisateur ".$row['login']." '><i class='fas fa-x'></i></a></td>";
                                        echo"</tr>";
                                    }
